...
if ($result->num_rows > 0) {
    ...
    if ($showMore >= $total_houses) {
        ...
        echo "<div class=\"flex justify-end mt-4 mr-6\">";
        echo "<a href=\"?houses=" . ($showMore + 6) . "\" class=\"bg-blue-500 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded\">Show More</a>";
...
<a class="weatherwidget-io" href="https://forecast7.com/uk/50d6226d25/rivne/" data-label_1="RIVNE" data-label_2="WEATHER" data-theme="orange" >RIVNE WEATHER</a>
<script>
